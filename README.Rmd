...
-   ***Cohort diagnostics*** which help to answer questions like how
    ...
    compare our study cohorts to the overall population by matching people
...
We can easily run all the analyses explained above (**database diagnostics**, **codelist diagnostics**, **cohort diagnostics**,
