...
Let's now explore additional functionalities that the ShinyDiagnostics offers. If we click to *Codelist diagnostics / Achilles code use* tab, we will first find a horizontal purple bar that will show us all the databases we included:
...
For **Cohort diagnostics** and **Population diagnostics**, we will also have the option to select the cohorts of interest:
