...
Cohort diagnostics performs the following analyses on our cohorts:
...
We will now use different functions to visualise the results generated by CohortDiagnostics. Notice that these functions are from CohortCharacteristics and CohortSurvival packages.
### Cohort counts
```{r}
