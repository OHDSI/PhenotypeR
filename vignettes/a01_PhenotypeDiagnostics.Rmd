...
# exportSummarisedResult(result, minCellCount = 0, fileName = "vignettes/Data/PhenotypeDiagnostics.csv")
result <- importSummarisedResult(path = here::here("vignettes/Data/PhenotypeDiagnostics.csv"))
```
