...
#> /tmp/RtmpnSJwH7/phenotypeDiagnostics_log_{date}_{time}1b4e537a450.txt
#> ℹ Creating log file:
#>   /tmp/RtmpnSJwH7/phenotypeDiagnostics_log_2026_04_29_12_51_271b4e537a450.txt.
#> [2026-04-29 12:51:27] - Log file created
#> [2026-04-29 12:51:27] - Database diagnostics - getting CDM Snapshot
#> [2026-04-29 12:51:27] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-29 12:51:31.095686
#> ✔ Summary finished, at 2026-04-29 12:51:31.147856
#> [2026-04-29 12:51:31] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-29 12:51:33.790831
#> ✔ Summary finished, at 2026-04-29 12:51:33.841943
#> [2026-04-29 12:51:34] - Codelist diagnostics - index event breakdown
...
#> [2026-04-29 12:51:36] - Cohort diagnostics - cohort attrition
#> [2026-04-29 12:51:36] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-29 12:51:37] - Cohort diagnostics - matched cohorts
...
#> [2026-04-29 12:51:51] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-29 12:51:55] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-29 12:51:55.638356
#> ✔ Summary finished, at 2026-04-29 12:51:55.731247
...
#> [2026-04-29 12:51:56] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-29 12:52:58] - Population diagnosics - denominator cohort
#> [2026-04-29 12:52:58] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 4 sec
#> [2026-04-29 12:53:03] - Population diagnosics - incidence
...
#> [2026-04-29 12:53:12] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-29 12:53:17] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-29 12:53:18] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpnSJwH7/PhenotypeRShiny
