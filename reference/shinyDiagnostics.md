...
#> ℹ Creating log file:
#>   /tmp/RtmpPEtTTw/phenotypeDiagnostics_log_2026_04_09_14_18_031e72677dcc7a.txt.
#> [2026-04-09 14:18:03] - Log file created
#> [2026-04-09 14:18:03] - Database diagnostics - getting CDM Snapshot
#> [2026-04-09 14:18:04] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-09 14:18:09.524843
#> ✔ Summary finished, at 2026-04-09 14:18:09.595501
#> [2026-04-09 14:18:09] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-09 14:18:13.468987
#> ✔ Summary finished, at 2026-04-09 14:18:13.564973
#> [2026-04-09 14:18:14] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-09 14:18:18] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-09 14:18:20] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-09 14:18:21] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-09 14:18:24.128181
#> ✔ Summary finished, at 2026-04-09 14:18:25.223035
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-09 14:18:26.032485
#> ✔ Summary finished, at 2026-04-09 14:18:26.233712
...
#> [2026-04-09 14:18:30] - Cohort diagnostics - cohort attrition
#> [2026-04-09 14:18:31] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-09 14:18:32] - Cohort diagnostics - matched cohorts
#> → Sampling cohort `tmp_118_sampled`
#> Returning entry cohort as the size of the cohorts to be sampled is equal or
#> smaller than `n`.
...
#> [2026-04-09 14:18:46] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-09 14:18:52] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-09 14:18:53.12845
#> ✔ Summary finished, at 2026-04-09 14:18:53.297841
#> [2026-04-09 14:18:53] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 417 estimates dropped as frequency less than 1%
...
#> [2026-04-09 14:20:07] - Population diagnosics - denominator cohort
#> [2026-04-09 14:20:07] - Population diagnosics - sampling person table to1e+05
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-09 14:20:14] - Population diagnosics - incidence
...
#> [2026-04-09 14:20:26] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-09 14:20:33] - Phenotype diagnostics - exporting results
#> [2026-04-09 14:20:33] - Exporting log file
...
#> not present in the summarised result: achilles_code_use, orphan_code_use, and
...
#> Warning: Expectations tab in cohort_count and large_scale_characteristics will be
#> removed, as none were provided.
#> Warning: '/tmp/RtmpPEtTTw/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/RtmpPEtTTw/PhenotypeRShiny
