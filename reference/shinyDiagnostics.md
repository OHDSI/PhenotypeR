...
#> /tmp/RtmpDEReDi/phenotypeDiagnostics_log_{date}_{time}1ca2a985959.txt
#> ℹ Creating log file:
#>   /tmp/RtmpDEReDi/phenotypeDiagnostics_log_2026_04_20_07_45_361ca2a985959.txt.
#> [2026-04-20 07:45:36] - Log file created
#> [2026-04-20 07:45:36] - Database diagnostics - getting CDM Snapshot
#> [2026-04-20 07:45:36] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 07:45:41.062738
#> ✔ Summary finished, at 2026-04-20 07:45:41.125278
#> [2026-04-20 07:45:41] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 07:45:44.373552
#> ✔ Summary finished, at 2026-04-20 07:45:44.442235
#> [2026-04-20 07:45:45] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-20 07:45:48] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-20 07:45:49] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-20 07:45:51] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 07:45:53.107544
#> ✔ Summary finished, at 2026-04-20 07:45:53.979124
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 07:45:54.656442
#> ✔ Summary finished, at 2026-04-20 07:45:54.827879
...
#> [2026-04-20 07:45:58] - Cohort diagnostics - cohort attrition
#> [2026-04-20 07:45:59] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-20 07:46:00] - Cohort diagnostics - matched cohorts
...
#> [2026-04-20 07:46:11] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-20 07:46:16] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 07:46:17.261864
#> ✔ Summary finished, at 2026-04-20 07:46:17.409549
...
#> [2026-04-20 07:46:17] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 202 estimates dropped as frequency less than 1%
...
#> [2026-04-20 07:47:04] - Population diagnosics - denominator cohort
#> [2026-04-20 07:47:04] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-20 07:47:10] - Population diagnosics - incidence
...
#> [2026-04-20 07:47:20] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-20 07:47:27] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-20 07:47:28] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpDEReDi/PhenotypeRShiny
