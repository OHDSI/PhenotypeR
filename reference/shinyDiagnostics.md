...
#> /tmp/RtmpUMSwSp/phenotypeDiagnostics_log_{date}_{time}1c0551269649.txt
#> ℹ Creating log file:
#>   /tmp/RtmpUMSwSp/phenotypeDiagnostics_log_2026_04_17_16_22_571c0551269649.txt.
#> [2026-04-17 16:22:57] - Log file created
#> [2026-04-17 16:22:57] - Database diagnostics - getting CDM Snapshot
#> [2026-04-17 16:22:58] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 16:23:02.673329
#> ✔ Summary finished, at 2026-04-17 16:23:02.733941
#> [2026-04-17 16:23:02] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 16:23:06.216834
#> ✔ Summary finished, at 2026-04-17 16:23:06.324363
#> [2026-04-17 16:23:07] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-17 16:23:10] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-17 16:23:11] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-17 16:23:13] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 16:23:15.635531
#> ✔ Summary finished, at 2026-04-17 16:23:16.499221
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 16:23:17.17105
#> ✔ Summary finished, at 2026-04-17 16:23:17.339675
...
#> [2026-04-17 16:23:21] - Cohort diagnostics - cohort attrition
#> [2026-04-17 16:23:21] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-17 16:23:22] - Cohort diagnostics - matched cohorts
...
#> [2026-04-17 16:23:34] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-17 16:23:39] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 16:23:40.318004
#> ✔ Summary finished, at 2026-04-17 16:23:40.439081
...
#> [2026-04-17 16:23:40] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-17 16:24:28] - Population diagnosics - denominator cohort
#> [2026-04-17 16:24:28] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-17 16:24:34] - Population diagnosics - incidence
...
#> [2026-04-17 16:24:45] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-17 16:24:51] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-17 16:24:52] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpUMSwSp/PhenotypeRShiny
