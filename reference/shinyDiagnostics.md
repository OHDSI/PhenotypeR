...
#> /tmp/RtmphoCyap/phenotypeDiagnostics_log_{date}_{time}1bbe1b43fe9.txt
#> ℹ Creating log file:
#>   /tmp/RtmphoCyap/phenotypeDiagnostics_log_2026_04_20_08_13_261bbe1b43fe9.txt.
#> [2026-04-20 08:13:26] - Log file created
#> [2026-04-20 08:13:26] - Database diagnostics - getting CDM Snapshot
#> [2026-04-20 08:13:26] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 08:13:30.757888
#> ✔ Summary finished, at 2026-04-20 08:13:30.815742
#> [2026-04-20 08:13:31] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 08:13:34.257497
#> ✔ Summary finished, at 2026-04-20 08:13:34.322515
#> [2026-04-20 08:13:35] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-20 08:13:38] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-20 08:13:39] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-20 08:13:41] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 08:13:42.92825
#> ✔ Summary finished, at 2026-04-20 08:13:43.802545
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 08:13:44.511103
#> ✔ Summary finished, at 2026-04-20 08:13:44.689514
...
#> [2026-04-20 08:13:48] - Cohort diagnostics - cohort attrition
#> [2026-04-20 08:13:48] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-20 08:13:49] - Cohort diagnostics - matched cohorts
...
#> [2026-04-20 08:14:01] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-20 08:14:06] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 08:14:06.649881
#> ✔ Summary finished, at 2026-04-20 08:14:06.774295
...
#> [2026-04-20 08:14:07] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 250 estimates dropped as frequency less than 1%
...
#> [2026-04-20 08:14:54] - Population diagnosics - denominator cohort
#> [2026-04-20 08:14:54] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-20 08:15:00] - Population diagnosics - incidence
...
#> [2026-04-20 08:15:10] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-20 08:15:17] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmphoCyap/PhenotypeRShiny
