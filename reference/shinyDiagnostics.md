...
#> ℹ Creating log file:
#>   /tmp/Rtmpp7kYFS/phenotypeDiagnostics_log_2026_02_20_09_38_141f54c2956a5.txt.
#> [2026-02-20 09:38:14] - Log file created
#> [2026-02-20 09:38:14] - Phenotype diagnostics - input validation
#> [2026-02-20 09:38:14] - Database diagnostics - input validation
#> [2026-02-20 09:38:14] - Database diagnostics - getting CDM Snapshot
#> [2026-02-20 09:38:14] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:38:19.550382
#> ✔ Summary finished, at 2026-02-20 09:38:19.618867
#> [2026-02-20 09:38:19] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:38:23.049191
#> ✔ Summary finished, at 2026-02-20 09:38:23.124942
#> [2026-02-20 09:38:23] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-02-20 09:38:27] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-02-20 09:38:28] - Codelist diagnostics - input validation
#> [2026-02-20 09:38:28] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-02-20 09:38:30] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:38:32.381771
#> ✔ Summary finished, at 2026-02-20 09:38:33.304987
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:38:34.017601
#> ✔ Summary finished, at 2026-02-20 09:38:34.194127
...
#> [2026-02-20 09:38:38] - Cohort diagnostics - input validation
#> [2026-02-20 09:38:38] - Cohort diagnostics - cohort attrition
#> [2026-02-20 09:38:38] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-02-20 09:38:39] - Cohort diagnostics - matched cohorts
...
#> [2026-02-20 09:38:51] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-02-20 09:38:57] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:38:57.929116
#> ✔ Summary finished, at 2026-02-20 09:38:58.062739
#> [2026-02-20 09:38:58] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 394 estimates dropped as frequency less than 1%
...
#> [2026-02-20 09:40:02] - Population diagnosics - input validation
#> [2026-02-20 09:40:02] - Population diagnosics - denominator cohort
#> [2026-02-20 09:40:02] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-02-20 09:40:09] - Population diagnosics - incidence
...
#> [2026-02-20 09:40:19] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-02-20 09:40:26] - Phenotype diagnostics - exporting results
#> [2026-02-20 09:40:26] - Exporting log file
...
#> Warning: drug_diagnostics not present in the summarised result. Removing tab from the
#> shiny app.
#> Warning: No survival analysis present in cohortDiagnostics. Removing tab from the shiny
#> app.
#> Warning: '/tmp/Rtmpp7kYFS/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/Rtmpp7kYFS/PhenotypeRShiny
