...
#> /tmp/RtmpH6w4xP/phenotypeDiagnostics_log_{date}_{time}1c5af670724.txt
#> ℹ Creating log file:
#>   /tmp/RtmpH6w4xP/phenotypeDiagnostics_log_2026_04_23_12_14_271c5af670724.txt.
#> [2026-04-23 12:14:27] - Log file created
#> [2026-04-23 12:14:27] - Database diagnostics - getting CDM Snapshot
#> [2026-04-23 12:14:27] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-23 12:14:31.734985
#> ✔ Summary finished, at 2026-04-23 12:14:31.80122
#> [2026-04-23 12:14:31] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-23 12:14:35.149187
#> ✔ Summary finished, at 2026-04-23 12:14:35.225403
#> [2026-04-23 12:14:36] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-23 12:14:39] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-23 12:14:40] - Codelist diagnostics - index event breakdown
...
#> [2026-04-23 12:14:42] - Cohort diagnostics - cohort attrition
#> [2026-04-23 12:14:42] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-23 12:14:43] - Cohort diagnostics - matched cohorts
...
#> [2026-04-23 12:14:54] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-23 12:14:59] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-23 12:15:00.175277
#> ✔ Summary finished, at 2026-04-23 12:15:00.301841
...
#> [2026-04-23 12:15:00] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-23 12:15:46] - Population diagnosics - denominator cohort
#> [2026-04-23 12:15:46] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-04-23 12:15:53] - Population diagnosics - incidence
...
#> [2026-04-23 12:16:03] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-23 12:16:09] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-23 12:16:10] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpH6w4xP/PhenotypeRShiny
