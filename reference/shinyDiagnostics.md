...
#> ℹ Creating log file:
#>   /tmp/RtmpRssshW/phenotypeDiagnostics_log_2026_01_12_13_15_511f131537ffcc.txt.
#> [2026-01-12 13:15:51] - Log file created
#> [2026-01-12 13:15:51] - Phenotype diagnostics - input validation
#> [2026-01-12 13:15:51] - Database diagnostics - input validation
#> [2026-01-12 13:15:51] - Database diagnostics - getting CDM Snapshot
#> [2026-01-12 13:15:52] - Database diagnostics - summarising person table
#> ℹ The following estimates will be computed:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 13:15:56.619337
#> ✔ Summary finished, at 2026-01-12 13:15:56.705458
#> [2026-01-12 13:15:56] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 13:16:00.31558
#> ✔ Summary finished, at 2026-01-12 13:16:00.409672
#> [2026-01-12 13:16:01] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-01-12 13:16:04] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-01-12 13:16:05] - Codelist diagnostics - input validation
#> [2026-01-12 13:16:05] - Codelist diagnostics - index event breakdown
...
#> [2026-01-12 13:16:07] - Cohort diagnostics - input validation
#> [2026-01-12 13:16:07] - Cohort diagnostics - cohort attrition
#> [2026-01-12 13:16:07] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-01-12 13:16:08] - Cohort diagnostics - matched cohorts
...
#> [2026-01-12 13:16:19] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-01-12 13:16:24] - Cohort diagnostics - age density
#> ℹ The following estimates will be computed:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 13:16:25.459005
#> ✔ Summary finished, at 2026-01-12 13:16:25.771433
#> [2026-01-12 13:16:25] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 1088 estimates dropped as frequency less than 1%
#> ✔ Summarising large scale characteristics
#> `cohort_sample` and `matched_sample` casted to character.
#> [2026-01-12 13:17:01] - Population diagnosics - input validation
#> [2026-01-12 13:17:01] - Population diagnosics - denominator cohort
#> [2026-01-12 13:17:01] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-01-12 13:17:07] - Population diagnosics - incidence
...
#> [2026-01-12 13:17:18] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-01-12 13:17:25] - Phenotype diagnostics - exporting results
#> [2026-01-12 13:17:25] - Exporting log file
...
#> app.
#> Warning: '/tmp/RtmpRssshW/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/RtmpRssshW/PhenotypeRShiny
