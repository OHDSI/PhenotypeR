...
#> ℹ Creating log file:
#>   /tmp/Rtmpirjlnf/phenotypeDiagnostics_log_2026_01_20_09_24_521f0d2f75441.txt.
#> [2026-01-20 09:24:52] - Log file created
#> [2026-01-20 09:24:52] - Phenotype diagnostics - input validation
#> [2026-01-20 09:24:52] - Database diagnostics - input validation
#> [2026-01-20 09:24:52] - Database diagnostics - getting CDM Snapshot
#> [2026-01-20 09:24:53] - Database diagnostics - summarising person table
#> ℹ The following estimates will be computed:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-20 09:24:57.210144
#> ✔ Summary finished, at 2026-01-20 09:24:57.292244
#> [2026-01-20 09:24:57] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-20 09:25:00.515938
#> ✔ Summary finished, at 2026-01-20 09:25:00.599675
#> [2026-01-20 09:25:01] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-01-20 09:25:04] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-01-20 09:25:05] - Codelist diagnostics - input validation
#> [2026-01-20 09:25:05] - Codelist diagnostics - index event breakdown
...
#> [2026-01-20 09:25:07] - Cohort diagnostics - input validation
#> [2026-01-20 09:25:07] - Cohort diagnostics - cohort attrition
#> [2026-01-20 09:25:07] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-01-20 09:25:08] - Cohort diagnostics - matched cohorts
...
#> [2026-01-20 09:25:19] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-01-20 09:25:24] - Cohort diagnostics - age density
#> ℹ The following estimates will be computed:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-20 09:25:25.249085
#> ✔ Summary finished, at 2026-01-20 09:25:25.38483
#> [2026-01-20 09:25:25] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 868 estimates dropped as frequency less than 1%
#> ✔ Summarising large scale characteristics
#> `cohort_sample` and `matched_sample` casted to character.
#> [2026-01-20 09:26:00] - Population diagnosics - input validation
#> [2026-01-20 09:26:00] - Population diagnosics - denominator cohort
#> [2026-01-20 09:26:00] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-01-20 09:26:06] - Population diagnosics - incidence
...
#> [2026-01-20 09:26:17] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-01-20 09:26:23] - Phenotype diagnostics - exporting results
#> [2026-01-20 09:26:23] - Exporting log file
...
#> app.
#> Warning: '/tmp/Rtmpirjlnf/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/Rtmpirjlnf/PhenotypeRShiny
