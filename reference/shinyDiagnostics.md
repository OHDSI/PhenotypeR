...
#> /tmp/RtmpRuZHZP/phenotypeDiagnostics_log_{date}_{time}1c0947ba8b32.txt
#> ℹ Creating log file:
#>   /tmp/RtmpRuZHZP/phenotypeDiagnostics_log_2026_04_20_11_01_381c0947ba8b32.txt.
#> [2026-04-20 11:01:38] - Log file created
#> [2026-04-20 11:01:38] - Database diagnostics - getting CDM Snapshot
#> [2026-04-20 11:01:38] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 11:01:42.827174
#> ✔ Summary finished, at 2026-04-20 11:01:42.883687
#> [2026-04-20 11:01:43] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 11:01:46.064039
#> ✔ Summary finished, at 2026-04-20 11:01:46.130854
#> [2026-04-20 11:01:46] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-20 11:01:50] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-20 11:01:51] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-20 11:01:52] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 11:01:54.630546
#> ✔ Summary finished, at 2026-04-20 11:01:55.520796
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 11:01:56.213832
#> ✔ Summary finished, at 2026-04-20 11:01:56.378869
...
#> [2026-04-20 11:02:00] - Cohort diagnostics - cohort attrition
#> [2026-04-20 11:02:00] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-20 11:02:01] - Cohort diagnostics - matched cohorts
...
#> [2026-04-20 11:02:12] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-20 11:02:18] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-20 11:02:18.524113
#> ✔ Summary finished, at 2026-04-20 11:02:18.643705
...
#> [2026-04-20 11:02:19] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-20 11:03:06] - Population diagnosics - denominator cohort
#> [2026-04-20 11:03:06] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-20 11:03:13] - Population diagnosics - incidence
...
#> [2026-04-20 11:03:23] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-20 11:03:30] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpRuZHZP/PhenotypeRShiny
