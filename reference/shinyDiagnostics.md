...
#> ℹ Creating log file:
#>   /tmp/RtmplkfJme/phenotypeDiagnostics_log_2026_02_20_13_41_361f732e175690.txt.
#> [2026-02-20 13:41:36] - Log file created
#> [2026-02-20 13:41:36] - Phenotype diagnostics - input validation
#> [2026-02-20 13:41:36] - Database diagnostics - input validation
#> [2026-02-20 13:41:36] - Database diagnostics - getting CDM Snapshot
#> [2026-02-20 13:41:37] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 13:41:41.919151
#> ✔ Summary finished, at 2026-02-20 13:41:41.975272
#> [2026-02-20 13:41:42] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 13:41:45.283402
#> ✔ Summary finished, at 2026-02-20 13:41:45.362869
#> [2026-02-20 13:41:46] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-02-20 13:41:49] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-02-20 13:41:50] - Codelist diagnostics - input validation
#> [2026-02-20 13:41:50] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-02-20 13:41:52] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 13:41:54.470508
#> ✔ Summary finished, at 2026-02-20 13:41:55.383204
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 13:41:56.06672
#> ✔ Summary finished, at 2026-02-20 13:41:56.238014
...
#> [2026-02-20 13:42:00] - Cohort diagnostics - input validation
#> [2026-02-20 13:42:00] - Cohort diagnostics - cohort attrition
#> [2026-02-20 13:42:00] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-02-20 13:42:01] - Cohort diagnostics - matched cohorts
...
#> [2026-02-20 13:42:14] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-02-20 13:42:19] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 13:42:20.055861
#> ✔ Summary finished, at 2026-02-20 13:42:20.193221
#> [2026-02-20 13:42:20] - Cohort diagnostics - large scale characteristics
...
#> [2026-02-20 13:43:26] - Population diagnosics - input validation
#> [2026-02-20 13:43:26] - Population diagnosics - denominator cohort
#> [2026-02-20 13:43:26] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-02-20 13:43:32] - Population diagnosics - incidence
...
#> [2026-02-20 13:43:43] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-02-20 13:43:50] - Phenotype diagnostics - exporting results
#> [2026-02-20 13:43:50] - Exporting log file
...
#> app.
#> Warning: '/tmp/RtmplkfJme/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/RtmplkfJme/PhenotypeRShiny
