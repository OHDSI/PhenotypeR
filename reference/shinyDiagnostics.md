...
#> /tmp/RtmpDI72pX/phenotypeDiagnostics_log_{date}_{time}1cc153c80175.txt
#> ℹ Creating log file:
#>   /tmp/RtmpDI72pX/phenotypeDiagnostics_log_2026_04_16_12_45_421cc153c80175.txt.
#> [2026-04-16 12:45:42] - Log file created
#> [2026-04-16 12:45:42] - Database diagnostics - getting CDM Snapshot
#> [2026-04-16 12:45:42] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 12:45:46.84529
#> ✔ Summary finished, at 2026-04-16 12:45:46.903484
#> [2026-04-16 12:45:47] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 12:45:50.286596
#> ✔ Summary finished, at 2026-04-16 12:45:50.362285
#> [2026-04-16 12:45:51] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-16 12:45:54] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-16 12:45:55] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-16 12:45:57] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 12:45:59.352463
#> ✔ Summary finished, at 2026-04-16 12:46:00.216531
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 12:46:00.886716
#> ✔ Summary finished, at 2026-04-16 12:46:01.053322
...
#> [2026-04-16 12:46:04] - Cohort diagnostics - cohort attrition
#> [2026-04-16 12:46:05] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-16 12:46:06] - Cohort diagnostics - matched cohorts
...
#> [2026-04-16 12:46:18] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-16 12:46:23] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 12:46:23.830976
#> ✔ Summary finished, at 2026-04-16 12:46:23.955383
...
#> [2026-04-16 12:46:24] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-16 12:47:13] - Population diagnosics - denominator cohort
#> [2026-04-16 12:47:13] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-16 12:47:19] - Population diagnosics - incidence
...
#> [2026-04-16 12:47:30] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-16 12:47:37] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-16 12:47:38] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpDI72pX/PhenotypeRShiny
