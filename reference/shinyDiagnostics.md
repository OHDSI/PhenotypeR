...
#> /tmp/RtmpoY3R77/phenotypeDiagnostics_log_{date}_{time}1c7c4e884c77.txt
#> ℹ Creating log file:
#>   /tmp/RtmpoY3R77/phenotypeDiagnostics_log_2026_04_17_09_09_451c7c4e884c77.txt.
#> [2026-04-17 09:09:45] - Log file created
#> [2026-04-17 09:09:45] - Database diagnostics - getting CDM Snapshot
#> [2026-04-17 09:09:45] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 09:09:49.571948
#> ✔ Summary finished, at 2026-04-17 09:09:49.632976
#> [2026-04-17 09:09:49] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 09:09:52.916716
#> ✔ Summary finished, at 2026-04-17 09:09:52.993712
#> [2026-04-17 09:09:53] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-17 09:09:57] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-17 09:09:58] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-17 09:09:59] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 09:10:01.680906
#> ✔ Summary finished, at 2026-04-17 09:10:02.526087
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 09:10:03.177284
#> ✔ Summary finished, at 2026-04-17 09:10:03.336326
...
#> [2026-04-17 09:10:07] - Cohort diagnostics - cohort attrition
#> [2026-04-17 09:10:07] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-17 09:10:08] - Cohort diagnostics - matched cohorts
...
#> [2026-04-17 09:10:19] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-17 09:10:24] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-17 09:10:25.164523
#> ✔ Summary finished, at 2026-04-17 09:10:25.292938
...
#> [2026-04-17 09:10:25] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-17 09:11:11] - Population diagnosics - denominator cohort
#> [2026-04-17 09:11:11] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-04-17 09:11:17] - Population diagnosics - incidence
...
#> [2026-04-17 09:11:27] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-17 09:11:34] - Exporting log file

shinyDiagnostics(result,
                tempdir())
#> ℹ Creating shiny from provided data
#> [2026-04-17 09:11:35] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpoY3R77/PhenotypeRShiny
