...
#> ℹ Creating log file:
#>   /tmp/Rtmpka40zE/phenotypeDiagnostics_log_2026_01_12_10_30_461ef037dfe07a.txt.
#> [2026-01-12 10:30:46] - Log file created
#> [2026-01-12 10:30:46] - Phenotype diagnostics - input validation
#> [2026-01-12 10:30:46] - Database diagnostics - input validation
#> [2026-01-12 10:30:46] - Database diagnostics - getting CDM Snapshot
#> [2026-01-12 10:30:46] - Database diagnostics - summarising person table
#> ℹ The following estimates will be computed:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:30:50.939411
#> ✔ Summary finished, at 2026-01-12 10:30:51.02658
#> [2026-01-12 10:30:51] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:30:54.344605
#> ✔ Summary finished, at 2026-01-12 10:30:54.435952
#> [2026-01-12 10:30:55] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-01-12 10:30:58] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-01-12 10:30:58] - Codelist diagnostics - input validation
#> [2026-01-12 10:30:59] - Codelist diagnostics - index event breakdown
...
#> [2026-01-12 10:31:00] - Cohort diagnostics - input validation
#> [2026-01-12 10:31:00] - Cohort diagnostics - cohort attrition
#> [2026-01-12 10:31:01] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-01-12 10:31:01] - Cohort diagnostics - matched cohorts
...
#> [2026-01-12 10:31:12] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-01-12 10:31:17] - Cohort diagnostics - age density
#> ℹ The following estimates will be computed:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:31:18.052845
#> ✔ Summary finished, at 2026-01-12 10:31:18.348171
#> [2026-01-12 10:31:18] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 910 estimates dropped as frequency less than 1%
#> ✔ Summarising large scale characteristics
#> `cohort_sample` and `matched_sample` casted to character.
#> [2026-01-12 10:31:51] - Population diagnosics - input validation
#> [2026-01-12 10:31:51] - Population diagnosics - denominator cohort
#> [2026-01-12 10:31:51] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-01-12 10:31:57] - Population diagnosics - incidence
...
#> [2026-01-12 10:32:07] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-01-12 10:32:14] - Phenotype diagnostics - exporting results
#> [2026-01-12 10:32:14] - Exporting log file
...
#> app.
#> Warning: '/tmp/Rtmpka40zE/PhenotypeRShiny/data/raw/expectations' already exists
#> ℹ Shiny app created in /tmp/Rtmpka40zE/PhenotypeRShiny
