...
#> /tmp/Rtmpo4zdli/phenotypeDiagnostics_log_{date}_{time}1c9134dc0aac.txt
#> ℹ Creating log file:
#>   /tmp/Rtmpo4zdli/phenotypeDiagnostics_log_2026_04_16_11_38_421c9134dc0aac.txt.
#> [2026-04-16 11:38:42] - Log file created
#> [2026-04-16 11:38:43] - Database diagnostics - getting CDM Snapshot
#> [2026-04-16 11:38:43] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:38:47.473078
#> ✔ Summary finished, at 2026-04-16 11:38:47.530595
#> [2026-04-16 11:38:47] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:38:50.81771
#> ✔ Summary finished, at 2026-04-16 11:38:50.883299
#> [2026-04-16 11:38:51] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-16 11:38:55] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-16 11:38:56] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-16 11:38:57] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:38:59.534901
#> ✔ Summary finished, at 2026-04-16 11:39:00.393314
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:39:01.04176
#> ✔ Summary finished, at 2026-04-16 11:39:01.203812
...
#> [2026-04-16 11:39:04] - Cohort diagnostics - cohort attrition
#> [2026-04-16 11:39:05] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-16 11:39:06] - Cohort diagnostics - matched cohorts
...
#> [2026-04-16 11:39:17] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-16 11:39:22] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:39:22.947125
#> ✔ Summary finished, at 2026-04-16 11:39:23.075886
...
#> [2026-04-16 11:39:23] - Cohort diagnostics - large scale characteristics
...
#> [2026-04-16 11:40:10] - Population diagnosics - denominator cohort
#> [2026-04-16 11:40:10] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-04-16 11:40:16] - Population diagnosics - incidence
...
#> [2026-04-16 11:40:26] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-16 11:40:33] - Exporting log file
...
#> ℹ Shiny app created in /tmp/Rtmpo4zdli/PhenotypeRShiny
