...
#> ℹ Creating log file:
#>   /tmp/Rtmpka40zE/phenotypeDiagnostics_log_2026_01_12_10_28_321ef06aef470d.txt.
#> [2026-01-12 10:28:32] - Log file created
#> [2026-01-12 10:28:32] - Phenotype diagnostics - input validation
#> [2026-01-12 10:28:32] - Database diagnostics - input validation
#> [2026-01-12 10:28:32] - Database diagnostics - getting CDM Snapshot
#> [2026-01-12 10:28:32] - Database diagnostics - summarising person table
#> ℹ The following estimates will be computed:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:28:36.995023
#> ✔ Summary finished, at 2026-01-12 10:28:37.079271
#> [2026-01-12 10:28:37] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:28:40.436866
#> ✔ Summary finished, at 2026-01-12 10:28:40.528114
#> [2026-01-12 10:28:41] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-01-12 10:28:44] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-01-12 10:28:45] - Codelist diagnostics - input validation
#> [2026-01-12 10:28:45] - Codelist diagnostics - index event breakdown
...
#> [2026-01-12 10:28:47] - Cohort diagnostics - input validation
#> [2026-01-12 10:28:47] - Cohort diagnostics - cohort attrition
#> [2026-01-12 10:28:47] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-01-12 10:28:48] - Cohort diagnostics - matched cohorts
...
#> [2026-01-12 10:28:59] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-01-12 10:29:04] - Cohort diagnostics - age density
#> ℹ The following estimates will be computed:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 10:29:04.554606
#> ✔ Summary finished, at 2026-01-12 10:29:04.696624
#> [2026-01-12 10:29:04] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 928 estimates dropped as frequency less than 1%
#> ✔ Summarising large scale characteristics
#> `cohort_sample` and `matched_sample` casted to character.
#> [2026-01-12 10:29:38] - Population diagnosics - input validation
#> [2026-01-12 10:29:38] - Population diagnosics - denominator cohort
#> [2026-01-12 10:29:38] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-01-12 10:29:44] - Population diagnosics - incidence
...
#> [2026-01-12 10:29:55] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-01-12 10:30:01] - Phenotype diagnostics - exporting results
#> [2026-01-12 10:30:01] - Exporting log file
# }
```
