...
#> ℹ Creating log file:
#>   /tmp/Rtmpp7kYFS/phenotypeDiagnostics_log_2026_02_20_09_35_151f54423bb2ec.txt.
#> [2026-02-20 09:35:15] - Log file created
#> [2026-02-20 09:35:15] - Phenotype diagnostics - input validation
#> [2026-02-20 09:35:15] - Database diagnostics - input validation
#> [2026-02-20 09:35:15] - Database diagnostics - getting CDM Snapshot
#> [2026-02-20 09:35:16] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:35:20.583187
#> ✔ Summary finished, at 2026-02-20 09:35:20.654307
#> [2026-02-20 09:35:20] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:35:24.173058
#> ✔ Summary finished, at 2026-02-20 09:35:24.247492
#> [2026-02-20 09:35:25] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-02-20 09:35:28] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-02-20 09:35:29] - Codelist diagnostics - input validation
#> [2026-02-20 09:35:29] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-02-20 09:35:31] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:35:33.535619
#> ✔ Summary finished, at 2026-02-20 09:35:34.455701
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:35:35.286168
#> ✔ Summary finished, at 2026-02-20 09:35:35.461455
...
#> [2026-02-20 09:35:39] - Cohort diagnostics - input validation
#> [2026-02-20 09:35:39] - Cohort diagnostics - cohort attrition
#> [2026-02-20 09:35:39] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-02-20 09:35:40] - Cohort diagnostics - matched cohorts
...
#> [2026-02-20 09:35:52] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-02-20 09:35:57] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-20 09:35:57.742815
#> ✔ Summary finished, at 2026-02-20 09:35:57.862386
#> [2026-02-20 09:35:58] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 416 estimates dropped as frequency less than 1%
...
#> [2026-02-20 09:37:03] - Population diagnosics - input validation
#> [2026-02-20 09:37:03] - Population diagnosics - denominator cohort
#> [2026-02-20 09:37:03] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 6 sec
#> [2026-02-20 09:37:10] - Population diagnosics - incidence
...
#> [2026-02-20 09:37:20] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-02-20 09:37:27] - Phenotype diagnostics - exporting results
#> [2026-02-20 09:37:27] - Exporting log file
# }
```
