...
#> /tmp/Rtmpo4zdli/phenotypeDiagnostics_log_{date}_{time}1c915d613dfd.txt
#> ℹ Creating log file:
#>   /tmp/Rtmpo4zdli/phenotypeDiagnostics_log_2026_04_16_11_36_111c915d613dfd.txt.
#> [2026-04-16 11:36:11] - Log file created
#> [2026-04-16 11:36:11] - Database diagnostics - getting CDM Snapshot
#> [2026-04-16 11:36:11] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:36:15.586899
#> ✔ Summary finished, at 2026-04-16 11:36:15.64298
#> [2026-04-16 11:36:15] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:36:18.893264
#> ✔ Summary finished, at 2026-04-16 11:36:18.959229
#> [2026-04-16 11:36:19] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-04-16 11:36:23] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-04-16 11:36:24] - Codelist diagnostics - index event breakdown
#> Getting counts of warfarin codes for cohort warfarin
#> [2026-04-16 11:36:25] - Codelist diagnostics - drug diagnostics
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:36:27.500126
#> ✔ Summary finished, at 2026-04-16 11:36:28.338228
#> ℹ The following estimates will be calculated:
#> • days_to_next_record: min, q01, q05, q25, median, q75, q95, q99, max,
#>   percentage_missing
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:36:28.986202
#> ✔ Summary finished, at 2026-04-16 11:36:29.147218
...
#> [2026-04-16 11:36:32] - Cohort diagnostics - cohort attrition
#> [2026-04-16 11:36:33] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-04-16 11:36:34] - Cohort diagnostics - matched cohorts
...
#> [2026-04-16 11:36:45] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-04-16 11:36:49] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-04-16 11:36:50.493383
#> ✔ Summary finished, at 2026-04-16 11:36:50.628645
...
#> [2026-04-16 11:36:51] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 257 estimates dropped as frequency less than 1%
...
#> [2026-04-16 11:37:36] - Population diagnosics - denominator cohort
#> [2026-04-16 11:37:36] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-04-16 11:37:42] - Population diagnosics - incidence
...
#> [2026-04-16 11:37:52] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-04-16 11:37:59] - Exporting log file
