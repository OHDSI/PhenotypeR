...
#> ℹ Creating log file:
#>   /tmp/RtmpkD6lFg/phenotypeDiagnostics_log_2026_01_12_17_11_251f1c54955419.txt.
#> [2026-01-12 17:11:25] - Log file created
#> [2026-01-12 17:11:25] - Phenotype diagnostics - input validation
#> [2026-01-12 17:11:25] - Database diagnostics - input validation
#> [2026-01-12 17:11:25] - Database diagnostics - getting CDM Snapshot
#> [2026-01-12 17:11:26] - Database diagnostics - summarising person table
#> ℹ The following estimates will be computed:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 17:11:30.347325
#> ✔ Summary finished, at 2026-01-12 17:11:30.425243
#> [2026-01-12 17:11:30] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 17:11:33.981528
#> ✔ Summary finished, at 2026-01-12 17:11:34.073292
#> [2026-01-12 17:11:34] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-01-12 17:11:38] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-01-12 17:11:38] - Codelist diagnostics - input validation
#> [2026-01-12 17:11:39] - Codelist diagnostics - index event breakdown
...
#> [2026-01-12 17:11:41] - Cohort diagnostics - input validation
#> [2026-01-12 17:11:41] - Cohort diagnostics - cohort attrition
#> [2026-01-12 17:11:41] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-01-12 17:11:41] - Cohort diagnostics - matched cohorts
...
#> [2026-01-12 17:11:53] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-01-12 17:11:58] - Cohort diagnostics - age density
#> ℹ The following estimates will be computed:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-01-12 17:11:59.365016
#> ✔ Summary finished, at 2026-01-12 17:11:59.514003
#> [2026-01-12 17:11:59] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 896 estimates dropped as frequency less than 1%
#> ✔ Summarising large scale characteristics
#> `cohort_sample` and `matched_sample` casted to character.
#> [2026-01-12 17:12:35] - Population diagnosics - input validation
#> [2026-01-12 17:12:35] - Population diagnosics - denominator cohort
#> [2026-01-12 17:12:35] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-01-12 17:12:41] - Population diagnosics - incidence
...
#> [2026-01-12 17:12:51] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-01-12 17:12:58] - Phenotype diagnostics - exporting results
#> [2026-01-12 17:12:58] - Exporting log file
# }
```
