...
#> ℹ Creating log file:
#>   /tmp/RtmpFkdoFJ/phenotypeDiagnostics_log_2026_02_08_18_59_431f481392237d.txt.
#> [2026-02-08 18:59:43] - Log file created
#> [2026-02-08 18:59:43] - Phenotype diagnostics - input validation
#> [2026-02-08 18:59:43] - Database diagnostics - input validation
#> [2026-02-08 18:59:43] - Database diagnostics - getting CDM Snapshot
#> [2026-02-08 18:59:43] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-08 18:59:47.566452
#> ✔ Summary finished, at 2026-02-08 18:59:47.622444
#> [2026-02-08 18:59:47] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-08 18:59:50.929231
#> ✔ Summary finished, at 2026-02-08 18:59:51.002376
#> [2026-02-08 18:59:51] - Database diagnostics - summarising clinical tables -
#> summary
...
#> [2026-02-08 18:59:55] - Database diagnostics - summarising clinical tables -
#> trends
#> [2026-02-08 18:59:56] - Codelist diagnostics - input validation
#> [2026-02-08 18:59:56] - Codelist diagnostics - index event breakdown
...
#> [2026-02-08 18:59:57] - Cohort diagnostics - input validation
#> [2026-02-08 18:59:58] - Cohort diagnostics - cohort attrition
#> [2026-02-08 18:59:58] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-02-08 18:59:58] - Cohort diagnostics - matched cohorts
...
#> [2026-02-08 19:00:10] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-02-08 19:00:15] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-02-08 19:00:15.695074
#> ✔ Summary finished, at 2026-02-08 19:00:15.821888
#> [2026-02-08 19:00:16] - Cohort diagnostics - large scale characteristics
...
#> Formatting result
#> 480 estimates dropped as frequency less than 1%
...
#> [2026-02-08 19:01:17] - Population diagnosics - input validation
#> [2026-02-08 19:01:17] - Population diagnosics - denominator cohort
#> [2026-02-08 19:01:17] - Population diagnosics - sampling person table to1e+06
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 5 sec
#> [2026-02-08 19:01:23] - Population diagnosics - incidence
...
#> [2026-02-08 19:01:33] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-02-08 19:01:39] - Phenotype diagnostics - exporting results
#> [2026-02-08 19:01:39] - Exporting log file
# }
```
