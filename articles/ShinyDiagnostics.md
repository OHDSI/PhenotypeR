...
Let’s now explore the Shiny App created together! Please, find it
...
We will always find (in all the tabs) a *download* icon on the right
...
(which is the case for *Population diagnositcs / Incidence*, where we
