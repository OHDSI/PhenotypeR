...
In this example we’re going to just create a cohort of individuals with
an ankle sprain using the Eunomia synthetic data.
...
- Overall and stratified by age groups: 0 to 17, 18 to 64, 65 to 150.
...
We can use
[IncidencePrevalence](https://darwin-eu.github.io/IncidencePrevalence/index.html)
package to visualise the results obtained.
